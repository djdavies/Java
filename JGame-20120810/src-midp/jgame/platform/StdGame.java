...
public abstract class StdGame extends JGEngine {
	...
	* default=Z. */
	public int key_fire      = KeyFire;
	/** Key for directional firing, default = WSAD keys */
	public int key_fireleft = '4', key_fireright= '6',
	           key_fireup   = '2', key_firedown = '5';
	/** Key for special action, default=X */
	public int key_action      = '8';
	...
	* Can be used to vary graphic sets, display stage number, etc. */
	...
	class YesNoDialog implements CommandListener {


		private Command softKey1;
		private Command softKey2;

		public Alert yesNoAlert;
		...
		public YesNoDialog(MIDlet midlet,String title,String message) {
			this.midlet = midlet;
			parent = Display.getDisplay(midlet).getCurrent();
