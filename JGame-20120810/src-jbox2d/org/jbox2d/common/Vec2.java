...
public class Vec2 {
	 ...
	 */
    // trusting the constructor to zero init these saves time(midp)
	static public int creationCount;
    public float x, y;

    public Vec2() {
		// we don't have to do anything since x and y will be inited with 0
        //this(0, 0);
    }

    public Vec2(float x, float y) {
		// removed this for performance (midp)
