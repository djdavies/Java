...
public class Mat22 {
    ...
    public Mat22() {
		// optimised: create empty vectors instead of clone.
		col1 = new Vec2();
		col2 = new Vec2();
	...
	static final float ftiMul = 1f/65536f;
	static final float ftiMulL = 1f/(65536L*65536L);
     ...
     */
    public Vec2 mul_fixed(Vec2 v) {
		// fixed point version
        return new Vec2(
			(  (long)(col1.x*65536f) * (long)(v.x*65536f)
			 + (long)(col2.x*65536f) * (long)(v.y*65536f) )*ftiMulL,
   			(  (long)(col1.y*65536f) * (long)(v.x*65536f)
			 + (long)(col2.y*65536f) * (long)(v.y*65536f) )*ftiMulL
		);
     ...
     * @return
     */
    public Mat22 mul_fixed(Mat22 R) {
        Mat22 C = new Mat22();
		// written out for efficiency (midp)
		// fixed point version
		C.col1.x = (  (long)(col1.x*65536f) * (long)(R.col1.x*65536f)
		            + (long)(col2.x*65536f) * (long)(R.col1.y*65536f) )*ftiMulL;
		C.col1.y = (  (long)(col1.y*65536f) * (long)(R.col1.x*65536f)
		            + (long)(col2.y*65536f) * (long)(R.col1.y*65536f) )*ftiMulL;
		C.col2.x = (  (long)(col1.x*65536f) * (long)(R.col2.x*65536f)
		            + (long)(col2.x*65536f) * (long)(R.col2.y*65536f) )*ftiMulL;
		C.col2.y = (  (long)(col1.y*65536f) * (long)(R.col2.x*65536f)
		            + (long)(col2.y*65536f) * (long)(R.col2.y*65536f) )*ftiMulL;
        ...
        //old code: C.set(this.mul(R.col1), this.mul(R.col2));
        return C;
    }
