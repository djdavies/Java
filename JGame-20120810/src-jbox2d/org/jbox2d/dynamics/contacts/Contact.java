...
public abstract class Contact {
	...
	/** Get the manifold, or null when none */
    public abstract Manifold getManifold();

	/** Get the manifold array. */
	// replaced by getManifold
    ...
    static void addType(ContactCreateFcn createFcn, int type1,
            int type2) {
    ...
    public static Contact createContact(Shape shape1, Shape shape2) {
        ...
        int type1 = shape1.m_type;
        int type2 = shape2.m_type;
        ...
        if (register != null) {
            if (register.primary) {
                ...
                for (int i = 0; i < c.getManifoldCount(); ++i) {
					// replaced by single-manifold version
    ...
    private static ContactRegister getContactRegister(int type1,
    int type2) {
		for (Enumeration e=s_registers.elements(); e.hasMoreElements(); ) {
			
        	ContactRegister cr = (ContactRegister)e.nextElement();
