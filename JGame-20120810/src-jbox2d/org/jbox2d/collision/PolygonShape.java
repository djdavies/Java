...
public class PolygonShape extends Shape implements SupportsGenericDistance{
    ...
    // midp implementation of asin. Only used by PolygonShape.
	// From: http://discussion.forum.nokia.com/forum/showthread.php?72840-Maths-acos-asin-atan
    ...
    // implementation of atan (for asin)
    ...
    public PolygonShape(ShapeDef def) {
    	...
    	for (int i = 0; i < m_vertexCount; ++i) {
    		m_vertices[i] = ((Vec2)poly.vertices.elementAt(i)).clone();
    	}	
...
//    	}
	...
	//    #endif
	        ...
	        for (int i = 0; i < count; ++i) {
	            ...
	            Vec2 p3 = i + 1 < count ?
					(Vec2)vs.elementAt(i+1) : (Vec2)vs.elementAt(0);
